...
TILENAME_SEED = 42
NUM_OF_TILES  = 16000
tiles = pd.read_csv(os.environ['RUN_DIR'] + '/data/Tilelist_DR3_1_All.csv')
...
reproc_tiles = pd.read_csv('./Reprocess_tiles.txt').values[:, 0]
...
if __name__ == '__main__':
    ...
    if args['Initialize']:
        ...
        for i, tilename in enumerate(tilenames):
            ...
            if i < args['TileStart']: 
                continue
            elif tilename not in reproc_tiles:
                continue
            else:
